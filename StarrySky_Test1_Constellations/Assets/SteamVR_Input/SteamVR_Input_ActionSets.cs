...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_SelectMenu p_SelectMenu;
        ...
        public static SteamVR_Input_ActionSet_SelectMenu SelectMenu
        {
            get
            {
                return SteamVR_Actions.p_SelectMenu.GetCopy<SteamVR_Input_ActionSet_SelectMenu>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_SelectMenu = ((SteamVR_Input_ActionSet_SelectMenu)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_SelectMenu>("/actions/SelectMenu")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.SelectMenu};
        }
    }
}
